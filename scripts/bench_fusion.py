...
change is worth adopting ([D025](../docs/decisions.md#d025)). Compiled numbers
are the ones that matter -- Inductor may already fuse some of this, and if it
does, the honest answer is that the source-level change earns nothing.
