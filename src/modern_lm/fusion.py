...
resumes into an identical model ([D025](../../docs/decisions.md#d025)).
...
def convert_checkpoint(payload: dict, *, to_fused: bool) -> dict:
    ...
    in the result reflects the direction converted, so the checkpoint carries
    the fact and `train.py --resume` builds the matching model without a flag.
    """
